...
const Vector3 Vector3::One(1.0f, 1.0f, 1.f);
...
const Vector3 Vector3::Infinity(CustomMaths::Infinity, CustomMaths::Infinity, CustomMaths::Infinity);
const Vector3 Vector3::NegInfinity(CustomMaths::NegInfinity, CustomMaths::NegInfinity, CustomMaths::NegInfinity);
...
Vector3 Vector3::TransformWithPerspDiv(const Vector3& vec, const Matrix4& mat, float w /*= 1.0f*/)
{
	...
	if (!CustomMaths::NearZero(CustomMaths::Abs(transformedW)))
	{
