...
void WorldOutlinerUI::Render()
{
	...
	ImGui::BeginChild("Scene Objects", ImVec2(ImGui::GetContentRegionAvail().x * 0.75, ImGui::GetContentRegionAvail().y * 0.75), false, ImGuiWindowFlags_AlwaysVerticalScrollbar);
